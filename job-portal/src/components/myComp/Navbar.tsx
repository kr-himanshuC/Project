                ...
                <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
                    ...
                    >
                        <div className="flex flex-row items-center border-b pb-4">
                            <Link
                                href="/"
                                className="cursor-pointer text-orangeColor font-bold text-xl pt-4 ps-4"
                            >
                                <span className="text-orangeColor">Job</span> Portal
                            </Link>
                            <button
                                onClick={toggleMobileMenu}
                                className="absolute top-4 right-4 text-slate-600 hover:text-orangeColor"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="w-8 h-8"
                        ...
                        <ul className="flex flex-col h-full gap-4 p-4">
                            {navItems.map((item, index) => (
                                <li
                                    key={index}
                                    className="flex items-center p-1 text-lg gap-x-2 text-slate-600 hover:text-orangeColor"
                                >
                            ...
                            <li className="mt-4">
                                <Link href={'/login'} className="bg-orangeColor text-white px-8 py-2 rounded-md hover:bg-white hover:text-black">
                                    Login
                                </Link>
